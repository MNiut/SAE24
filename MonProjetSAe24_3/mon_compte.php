...
// If no patient is logged in, redirect them to the login page.
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action']) && $_POST['action'] == 'book_rdv') {
    ...
    $stmt = mysqli_prepare($conn, "INSERT INTO rendezvous (id_patient, date_rdv, motif, statut) VALUES (?, ?, ?, 'Confirmé')");
...
$header_title = "Bienvenue, " . htmlspecialchars($patient_prenom);
$current_page_url = "mon_compte.php";
$path_prefix = "./";
...
<main>
    ...
    <?php else : ?>
        <table class="team-table">
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo htmlspecialchars(date('d/m/Y à H:i', strtotime($rdv['date_rdv']))); ?></td>
    ...
    <?php if (isset($_GET['success'])) echo '<p class="success-message">Votre rendez-vous a été enregistré avec succès !</p>'; ?>
